...
/**
 * Hourly trend quad widget config activity.
 */
@AndroidEntryPoint
class HourlyTrendQuadWidgetConfigActivity : AbstractWidgetConfigActivity() {
    ...
    override fun updateWidgetView() {
        HourlyTrendQuadWidgetIMP.updateWidgetView(this, locationNow)
    }

    override val remoteViews: RemoteViews
        get() {
            return HourlyTrendQuadWidgetIMP.getRemoteViews(
                this,
                locationNow,
    ...
    override val configStoreName: String
        get() {
            return getString(R.string.sp_widget_hourly_trend_quad_setting)
        }
}
