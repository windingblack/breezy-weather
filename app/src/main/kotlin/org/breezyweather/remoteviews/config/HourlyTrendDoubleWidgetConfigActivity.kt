...
/**
 * Hourly trend double widget config activity.
 */
@AndroidEntryPoint
class HourlyTrendDoubleWidgetConfigActivity : AbstractWidgetConfigActivity() {
    ...
    override fun updateWidgetView() {
        HourlyTrendDoubleWidgetIMP.updateWidgetView(this, locationNow)
    }

    override val remoteViews: RemoteViews
        get() {
            return HourlyTrendDoubleWidgetIMP.getRemoteViews(
                this,
                locationNow,
    ...
    override val configStoreName: String
        get() {
            return getString(R.string.sp_widget_hourly_trend_double_setting)
        }
}
